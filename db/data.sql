...
VALUES
    (2, 'fine_issued', 'Nowa kara', 'Twoje wypożyczenie zostało oznaczone jako przeterminowane.', 'fine', 1, FALSE, CURRENT_TIMESTAMP),
    (3, 'order_update', 'Zamówienie złożone', 'Zamówienie na kolejne egzemplarze książki zostało wysłane do dostawcy.', 'order', 1, FALSE, CURRENT_TIMESTAMP);
